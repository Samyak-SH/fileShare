          ...
          >
            {selectedFile ? (
              <div className="space-y-2">
                <FileIcon className="h-8 w-8 mx-auto text-black" />
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm text-gray-600">Drag and drop a file here, or click to select</div>
                <input
                  type="file"
          ...
          {selectedFile && (
            <div className="space-y-2">
              ...
              {selectedFile && fileName.trim().length === 0 && (
                <div className="text-xs text-red-600 mt-1">File name is required</div>
              )}
            </div>
          )}
